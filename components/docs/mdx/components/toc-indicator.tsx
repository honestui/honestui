...
// list taller than any fixed step, and the path, and with it the active marker, // would drift a full line further out of place with each wrapped entry above it.
