...
Start with [Get Started](/docs/get-started) to install the base setup. Then browse [Our Components](/docs/component-guide) to understand how component pages are structured.
