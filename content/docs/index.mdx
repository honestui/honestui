---
title: Introduction
description: A practical introduction to Honest UI and how the docs are organized.
---

## What is Honest UI?

**Honest UI** is an open-source set of React components, examples, and patterns.
...
Honest UI is not a black-box component package. You can inspect the source, change the styles, and keep only the pieces you need.
...
- **Animated components** for purposeful state, layout, text, and gesture transitions.
...
Many UI kits only give you a visual shell. Honest UI gives you the structure, behavior, and examples needed to build real screens faster.

The goal is simple: start with good defaults, then customize without fighting the library.

Honest UI works well when you want:
...
Start with [Get Started](/docs/get-started) to install the base setup. Then browse [Our Components](/docs/component-guide) or [Animated Components](/docs/animated) to understand how component pages are structured.

Our component pages include:
...
Honest UI follows a few steady rules:
...
Honest UI is open source under the **MIT license**.
