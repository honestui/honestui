---
title: Introduction
metaTitle: React UI Component Library Documentation
metaDescription: Explore Honest UI documentation for open-source React UI components, charts, icons, animated components, themes, and WebGL effects.
...
| Product components | Honest UI CLI | Copied into your project |
...
- [Product components](/docs/product) combines primitives into complete application patterns such as data tables.
- [Theme](/docs/theme/overview) explains the color, typography, spacing, radius, and effects shared by UI components.
