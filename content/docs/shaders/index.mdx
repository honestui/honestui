...
Use Gradient Blinds, Grainient, or Light Rays for atmospheric backgrounds. Each one works from sensible defaults and can be customized without supplying external assets.
