...
<Anatomy title="DataTable">
  <AnatomyItem
    name="Toolbar"
    description="Search, filters, column controls, and application actions"
  />
  <AnatomyItem
    name="Content"
    description="Column headers, data rows, loading, empty, and error states"
  />
  <AnatomyItem
    name="Footer"
    description="Selection summary, page range, and pagination"
  />
</Anatomy>
