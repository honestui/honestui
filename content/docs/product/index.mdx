...
Product components package related controls and state handling in one copied component. Data Table adds common record controls to a native HTML table. Data Grid adds column customization, typed filters, editing, server-managed state, and row virtualization for larger datasets.
