---
title: Get Started
description: Install Honest UI, add your first component, and understand the setup.
---
...
```bash
npx honestui@latest add base
```

This installs the shared setup that most components expect. It may add CSS variables, utility helpers, and dependencies used by Honest UI components.
...
Browse [Our Components](/docs/component-guide) to understand how the component pages are organized.

Read [Accessibility](/docs/accessibility) before changing keyboard behavior, focus styles, labels, or validation messages.

If you want to contribute back to Honest UI, read the [Contributing Guide](/docs/contributing).
