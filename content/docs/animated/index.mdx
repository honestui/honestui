...
The collection covers animated actions, text, navigation, disclosures, counters, and pointer-responsive effects. Use the reload control in any preview to replay entrance motion, then switch to Code to inspect the exact example.
