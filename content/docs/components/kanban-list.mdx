---
title: Kanban List
description: A sortable collection for organizing items in kanban or list views.
---
...
<ApiTable>
  <ApiRow name="view" type='"kanban" | "list"' default='"kanban"'>Sets the collection layout.</ApiRow>
  <ApiRow name="defaultItems" type="KanbanListItem[]">Sets the initial items.</ApiRow>
  <ApiRow name="onItemsChange" type="(items: KanbanListItem[]) => void">Runs after an item is moved.</ApiRow>
  <ApiRow name="columns" type="KanbanListStage[]">Limits the stages shown.</ApiRow>
  <ApiRow name="className" type="string">Adds a class name to the root element.</ApiRow>
  <ApiRow name="ariaLabel" type="string" default="Kanban list">Sets the accessible name for the collection.</ApiRow>
</ApiTable>
