---
title: Accessibility
description: How Honest UI components support keyboard, screen-reader, and form accessibility.
---

Accessibility is part of the component structure, not a final polish step.

Honest UI uses native HTML whenever possible. For complex interactions such as dialogs, menus, popovers, comboboxes, and tabs, Honest UI uses accessible primitives so keyboard navigation, focus handling, and ARIA state can be handled consistently.

## What Honest UI provides

Honest UI components are designed to support:
