...
- Added complete starter projects for Next.js, Vite, TanStack Start, React Router, Astro, and Laravel.
- Added monorepo starters for Next.js, Vite, TanStack Start, React Router, and Astro.
- Moved CLI starter source into the public [honestui-starters repository](https://github.com/honestui/honestui-starters). Each starter includes the complete public component registry, HonestUI styles, and local font files.

## August 25–27, 2026

- Added the [DataTable](/docs/product/data-table) component with search, filters, pagination, a toolbar, and view options.
- Added the [DataGrid](/docs/product/data-grid) component with virtualized rows, inline editing, filtering, and selection.
- Added the [DateRangePicker](/docs/product/date-range-picker) component with a calendar, presets, and date limits.
- Added the [Filter Bar](/docs/product/filter-bar) component with text, number, and date range fields, async loading, and a DataTable integration.
- Added the [File Upload](/docs/product/file-upload) component with drag and drop, paste, validation, and image previews.
