// The rendering engine a chart is built on. Honest UI ships one file per chart per
// provider — you install `@honestui/recharts-area-chart` or `@honestui/echarts-area-chart`, never
...
// The exceptions are the intro (/docs) and Chart Config (/docs/charts/chart-config), which
...
export const PROVIDER_META: Record<Provider, ProviderMeta> = {
  recharts: {
    id: "recharts",
    name: "Recharts",
    tagline: "SVG · the original Honest UI charts",
    available: true,
  },
  echarts: {
    id: "echarts",
...
// pages (/docs, /docs/charts/chart-config) keep the switcher on their engine across reloads.
export const PROVIDER_STORAGE_KEY = "honest-ui-chart-provider";
 ...
 * /docs/charts/chart-config, so the switcher can show "no engine selected" instead of
