...
beforeEach(() => {
  ...
  mockFs.mkdtemp.mockResolvedValue("/tmp/honestui-test")
})
...
export const DialogRoot = Root`
  ...
  it("should handle real-world honestui patterns from registry files", async () => {
    // This test captures all the actual import patterns found in the honestui registry
...
export const Button = SlotPrimitive.Slot`
  ...
  it("should handle the special sheet.tsx pattern from registry", async () => {
    // In honestui, sheet.tsx imports from react-dialog instead of a dedicated sheet package
...
export const FormControl = SlotPrimitive.Slot`
  ...
  it("should handle all 26 packages used in honestui registry", async () => {
