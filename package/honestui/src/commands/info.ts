...
const CODE_BASE = `${HONESTUI_URL}/code/apps/v4/registry/bases`
...
export async function collectInfo(
  ...
  return {
    ...
    components,
    links: {
      docs: `${HONESTUI_URL}/docs`,
      components: `${HONESTUI_URL}/docs/components/${base}/[component].md`,
      ui: `${CODE_BASE}/${base}/ui/[component].tsx`,
      examples: `${CODE_BASE}/${base}/examples/[component]-example.tsx`,
      schema: `${HONESTUI_URL}/schema.json`,
    },
  }
}
...
export function printPresetInfo(
  ...
  if (!preset?.code) {
    ...
    printEntries({
      ...
      url: `${HONESTUI_URL}/create?preset=${preset.code}`,
    })
