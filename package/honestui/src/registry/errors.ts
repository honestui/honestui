...
export class RegistryParseError extends RegistryError {
  ...
  constructor(
    ...
    super(message, {
      ...
      suggestion:
        options.suggestion ??
        `The registry item may be corrupted or have an invalid format. Please make sure it returns a valid JSON object. See ${HONESTUI_URL}/schema/registry-item.json.`,
    })
...
export class RegistryInvalidNamespaceError extends RegistryError {
  constructor(public readonly name: string) {
    const message = `Invalid registry namespace: "${name}". Registry names must start with @ (e.g., @honestui, @v0).`
...
export class ConfigMissingError extends RegistryError {
  constructor(public readonly cwd: string) {
    ...
    super(message, {
      ...
      context: { cwd },
      suggestion:
        "Run 'npx honestui@latest init' to create a components.json file, or check that you're in the correct directory.",
    })
...
export class ConfigParseError extends RegistryError {
  constructor(
    ...
    super(message, {
      ...
      context: { cwd },
      suggestion:
        "Check your components.json file for syntax errors or invalid configuration. Run 'npx honestui@latest init' to regenerate a valid configuration.",
    })
...
export class RegistriesIndexParseError extends RegistryError {
  ...
  constructor(parseError: unknown) {
    ...
    super(message, {
      ...
      context: { parseError },
      suggestion:
        "The registries index may be corrupted or have invalid registry namespace format. Registry names must start with @ (e.g., @honestui, @example).",
    })
