...
export const REGISTRY_URL =
  process.env.REGISTRY_URL ?? "https://honestui.com/r"

export const HONESTUI_URL = REGISTRY_URL.replace(/\/r\/?$/, "")

export const DEFAULT_REGISTRY_NAME = "@honestui"
...
export const BUILTIN_REGISTRIES: z.infer<typeof registryConfigSchema> = {
  "@honestui": `${REGISTRY_URL}/{name}.json`,
}
