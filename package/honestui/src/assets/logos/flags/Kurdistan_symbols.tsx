...
export interface KurdistanSymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const KurdistanSymbols = React.forwardRef<SVGSVGElement, KurdistanSymbolsProps>(
...
KurdistanSymbols.displayName = "KurdistanSymbols";

export const KurdistanSymbolsMetadata = {
  id: "Kurdistan_symbols",
  baseId: "Kurdistan",
  variant: "symbols",
  name: "Kurdistan",
  category: "flags",
...
export default KurdistanSymbols;
