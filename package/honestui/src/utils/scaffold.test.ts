...
describe("defaultScaffold", () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks()
    delete process.env.HONESTUI_TEMPLATE_DIR
    delete process.env.HONESTUI_GITHUB_URL
    mockExit = vi
      .spyOn(process, "exit")
  ...
  it("should use local templates when HONESTUI_TEMPLATE_DIR is set", async () => {
    process.env.HONESTUI_TEMPLATE_DIR = "/local/templates"
